...
ggsave(file=file.path(resultsDir,"SuppFig3.jaccard.simulations.0.30.facets.png"), all.0.30, width = 20, height = 16, units = "cm")
ggsave(file=file.path(resultsDir,"SuppFig3.jaccard.simulations.0.30.facets.pdf"), all.0.30, width = 20, height = 16, units = "cm")
